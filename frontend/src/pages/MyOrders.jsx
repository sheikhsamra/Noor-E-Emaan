...
const STATUS_STYLE = {
  ...
  Confirmed: { dot: "bg-blue-500",   text: "text-blue-700",   bg: "bg-blue-50   border-blue-200",   label: "Confirmed" },
  Shipped:   { dot: "bg-purple-500", text: "text-purple-700", bg: "bg-purple-50 border-purple-200", label: "Shipped"   },
